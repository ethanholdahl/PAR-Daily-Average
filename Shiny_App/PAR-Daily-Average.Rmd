...
```{r diagram1, echo=FALSE,out.width="49%", out.height="20%", fig.cap="diagram of solar radiation", fig.show='hold', fig.align='center'}
knitr::include_graphics(c('Sun-Diagram-Solo.PNG', 'Sun-Diagram-Zoomed.PNG'))
```
