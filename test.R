...
time_ele_PAR = add_ratio(t,  Latitude,  Longitude,  year,  day)
...
p
if( Wang) p = p + geom_line(data =  time_ele_PAR, aes(x = time, y = wang_PAR, color = wang_ratio))
if( ratio) p = p + geom_line(data =  time_ele_PAR, aes(x = time, y = linear_PAR, color = linear_ratio))
...
if( Wang) p = p + geom_line(data =  time_ele_PAR, aes(x = time, y = wang_ratio, color = wang_PAR))
